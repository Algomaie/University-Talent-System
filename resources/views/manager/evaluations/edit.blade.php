    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <form action="{{ route('manager.evaluations.update', $submission) }}" method="POST" id="evaluationForm">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="mb-6">
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input id="is_nominated" name="is_nominated" type="checkbox" value="1" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded" {{ old('is_nominated', $evaluation->is_nominated) ? 'checked' : '' }}>
                                </div>
