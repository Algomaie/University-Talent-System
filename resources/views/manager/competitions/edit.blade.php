    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <form action="{{ route('manager.competitions.update', $competition) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Arabic Title -->
                        <div>
                            <label for="title_ar" class="block text-sm font-medium text-gray-900 mb-1">
                                {{ __('Title (Arabic)') }} <span class="text-red-500">*</span>
                            </label>
                            <input type="text" 
                                   name="title_ar" 
                                   id="title_ar" 
                                   value="{{ old('title_ar', $competition->title_ar) }}"
                        ...
                        <!-- English Title -->
                        <div>
                            <label for="title_en" class="block text-sm font-medium text-gray-900 mb-1">
                                {{ __('Title (English)') }} <span class="text-red-500">*</span>
                            </label>
                            <input type="text" 
                                   name="title_en" 
                                   id="title_en" 
                                   value="{{ old('title_en', $competition->title_en) }}"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                   required>
                            @error('title_en')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <!-- Arabic Description -->
                        <div>
                            <label for="description_ar" class="block text-sm font-medium text-gray-900 mb-1">
                            ...
                            <textarea name="description_ar" 
                                      ...
                                      rows="4"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                      required>{{ old('description_ar', $competition->description_ar) }}</textarea>
                        ...
                        <!-- English Description -->
                        <div>
                            <label for="description_en" class="block text-sm font-medium text-gray-900 mb-1">
                            ...
                            <textarea name="description_en" 
                                      ...
                                      rows="4"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                      required>{{ old('description_en', $competition->description_en) }}</textarea>
                        ...
                        <!-- Start Date -->
                        <div>
                            <label for="start_date" class="block text-sm font-medium text-gray-900 mb-1">
                        ...
                        <!-- End Date -->
                        <div>
                            <label for="end_date" class="block text-sm font-medium text-gray-900 mb-1">
                        ...
                        <div>
                            <label for="registration_deadline" class="block text-sm font-medium text-gray-900 mb-1">
                                {{ __('Registration Deadline') }} <span class="text-red-500">*</span>
                            </label>
                            <input type="date" 
                                   name="registration_deadline" 
                                   id="registration_deadline" 
                                   value="{{ old('registration_deadline', $competition->registration_deadline->format('Y-m-d')) }}"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                   required>
                        ...
                        <!-- Max Participants -->
                        <div>
                            <label for="max_participants" class="block text-sm font-medium text-gray-900 mb-1">
                                {{ __('Max Participants') }}
                            </label>
                            <input type="number" 
                        ...
                        <div>
                            ...
                            <select name="status" 
                                ...
                                <option value="cancelled" {{ old('status', $competition->status) == 'cancelled' ? 'selected' : '' }}>{{ __('Cancelled') }}</option>
                            </select>
                            @error('status')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                                ...
                                @foreach($talents as $talent)
                                    <div class="flex items-center">
                                        <input type="checkbox" 
                                               ...
                                               {{ in_array($talent->id, old('allowed_talents', $selectedTalents)) ? 'checked' : '' }}>
                                        <label for="talent_{{ $talent->id }}" class="ml-2 block text-sm text-gray-900">
                                            {{ $talent->name }}
                                        </label>
                                    </div>
                                @endforeach
                        ...
                        <!-- Evaluation Criteria -->
                        <div class="md:col-span-2">
                            <label for="evaluation_criteria" class="block text-sm font-medium text-gray-900 mb-1">
                            ...
                            <textarea name="evaluation_criteria" 
                                      ...
                                      rows="4"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                      placeholder="{{ __('Enter evaluation criteria and guidelines for evaluators...') }}">{{ old('evaluation_criteria', $competition->evaluation_criteria) }}</textarea>
