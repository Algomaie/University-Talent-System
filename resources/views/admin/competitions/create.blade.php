            ...
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <form id="competitionForm" action="{{ route('admin.competitions.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            <label for="title_ar" class="block text-sm font-medium text-gray-900 mb-2">{{ __('Title (Arabic)') }}</label>
                        ...
                        <div>
                            <label for="title_en" class="block text-sm font-medium text-gray-900 mb-2">{{ __('Title (English)') }}</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                        <div>
                            <label for="start_date" class="block text-sm font-medium text-gray-900 mb-2">{{ __('Start Date') }}</label>
                        ...
                        <div>
                            <label for="end_date" class="block text-sm font-medium text-gray-900 mb-2">{{ __('End Date') }}</label>
                        ...
                        <div>
                            <label for="registration_deadline" class="block text-sm font-medium text-gray-900 mb-2">{{ __('Registration Deadline') }}</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                        ...
                        <div>
                            <label for="max_participants" class="block text-sm font-medium text-gray-900 mb-2">{{ __('Max Submissions Per Student') }}</label>
                        ...
                        <div>
                            <label for="allowed_talents" class="block text-sm font-medium text-gray-900 mb-2">{{ __('Allowed Talents') }}</label>
                    ...
                    <div class="flex justify-end pt-4 border-t border-gray-200">
                        <a href="{{ route('admin.competitions.index') }}" class="mr-3 inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-900 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            {{ __('Cancel') }}
                        </a>
