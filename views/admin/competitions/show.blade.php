            ...
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <p class="text-gray-700">{{ $competition->title_ar }}</p>
                    </div>

                    <div>
                        <h3 class="text-lg font-medium text-gray-900 mb-2">{{ __('Title (English)') }}</h3>
                        <p class="text-gray-700">{{ $competition->title_en }}</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    <div>
                        ...
                        <p class="text-gray-700">{{ $competition->start_date->format('Y-m-d') }}</p>
                    </div>

                    <div>
                        <h3 class="text-lg font-medium text-gray-900 mb-2">{{ __('End Date') }}</h3>
                        <p class="text-gray-700">{{ $competition->end_date->format('Y-m-d') }}</p>
                    </div>

                    <div>
                        <h3 class="text-lg font-medium text-gray-900 mb-2">{{ __('Registration Deadline') }}</h3>
                        <p class="text-gray-700">{{ $competition->registration_deadline->format('Y-m-d') }}</p>
                    </div>
                </div>

                <div class="mb-6">
                    <h3 class="text-lg font-medium text-gray-900 mb-2">{{ __('Description (Arabic)') }}</h3>
                    <p class="text-gray-700 whitespace-pre-line">{{ $competition->description_ar }}</p>
                </div>

                <div class="mb-6">
                    <h3 class="text-lg font-medium text-gray-900 mb-2">{{ __('Description (English)') }}</h3>
                    <p class="text-gray-700 whitespace-pre-line">{{ $competition->description_en }}</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-700">{{ $competition->max_participants ?? __('Unlimited') }}</p>
                    </div>
