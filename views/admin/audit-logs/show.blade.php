                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-3">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700">{{ __('Action') }}</label>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        @if($auditLog->action == 'create')
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('Created Values') }}</label>
                        ...
                        @elseif($auditLog->action == 'update')
                            <div class="space-y-4">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('Old Values') }}</label>
                                    <div class="bg-white p-3 rounded border">
                                        <pre class="text-xs overflow-x-auto">{{ json_encode($auditLog->old_values, JSON_PRETTY_PRINT) }}</pre>
                                    </div>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('New Values') }}</label>
                                    <div class="bg-white p-3 rounded border">
                                        <pre class="text-xs overflow-x-auto">{{ json_encode($auditLog->new_values, JSON_PRETTY_PRINT) }}</pre>
                                    </div>
                                </div>
                        ...
                        @elseif($auditLog->action == 'delete')
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('Deleted Values') }}</label>
                                <div class="bg-white p-3 rounded border">
                                    <pre class="text-xs overflow-x-auto">{{ json_encode($auditLog->old_values, JSON_PRETTY_PRINT) }}</pre>
                                </div>
                            </div>
