            ...
            <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2">
                            <li><a href="{{ route('home') }}" class="text-gray-700 dark:text-gray-300 hover:text-primary-500 transition-colors"><i class="fas fa-home me-2"></i>{{ __('Home') }}</a></li>
                            <li><a href="{{ route('about') }}" class="text-gray-700 dark:text-gray-300 hover:text-primary-500 transition-colors"><i class="fas fa-info-circle me-2"></i>{{ __('About') }}</a></li>
                        </ul>
                    </div>
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">
                        ...
                        <p class="text-gray-700 dark:text-gray-300">
                            <i class="fas fa-envelope me-2"></i>{{ __('Email') }}: info@university.edu<br>
                            <i class="fas fa-phone me-2"></i>{{ __('Phone') }}: +966 11 123 4567
                        </p>
                    </div>
                </div>
